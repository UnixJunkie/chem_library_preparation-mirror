#!/bin/bash
# Meta script and text file from JRM to Cassiano/Marco/Maria, 29th of March 2018
...
##JR## Trust me, the ill-defined LP atoms of halogens make your life hell.

##JR## Step 7: Create ABSINTH files
mkdir 4absinth
